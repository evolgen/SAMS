...
for curr_elem_lst1 in range(0, len(triplets_thrice)):
    if(triplets_thrice[curr_elem_lst1][0][0] == triplets_thrice[curr_elem_lst1][1][0] and
            triplets_thrice[curr_elem_lst1][2][0] == triplets_thrice[curr_elem_lst1][1][0] and
            triplets_thrice[curr_elem_lst1][0][2] == triplets_thrice[curr_elem_lst1][1][2] and
            triplets_thrice[curr_elem_lst1][2][2] == triplets_thrice[curr_elem_lst1][1][2]):
...
#                        next
                    if all(nucl1 in accepted_nucleotides for nucl1 in curr_mrca1_nucl1):
                        ...
                        if(curr_species1_nucl1[0] == curr_mrca1_nucl1[0] and
                           curr_species2_nucl1[0] == curr_mrca1_nucl1[0] and
                           curr_species1_nucl1[2] == curr_mrca1_nucl1[2] and
                           curr_species2_nucl1[2] == curr_mrca1_nucl1[2]):
